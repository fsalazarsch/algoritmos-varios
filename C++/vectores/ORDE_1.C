...
void menuprin()
{
 ...
 while(1)
 {
  clrscr();
  textcolor(25);
  gotoxy (23,6); cprintf ("___________________________________________");textcolor(25);
  gotoxy (23,7);cprintf  ("|        UNIVERSITARIA DE SANTANDER      ");textcolor(25);
  ...
  gotoxy (23,11);cprintf ("|            1. METODOS DE ORDENAMIENTO     | ");textcolor(25);
  gotoxy (23,12);cprintf ("|                                           |");
  gotoxy(23,13); cprintf ("|-------------------------------------------|");
  gotoxy(23,14);cprintf  ("|            2. SALIR                       |");
  gotoxy(23,15); cprintf ("|-------------------------------------------|");
  gotoxy(23,16); cprintf ("|  ROBERTO OROZCO Y ADRIANA BOTELLO         |");
...
/* sound(rand());delay(100);*/ gotoxy (23,19);cprintf ("      ***  DIGITE UNA OPCION  [ ]  ***      ");
  textcolor(19+130);
  gotoxy (20,22);cprintf("Programador: ROBERTO OROZCO Y ADRIANA BOTELLO");normvideo();
  gotoxy (54,19);op=getchar();
  sound(op*30);delay(100);nosound();
  normvideo();
  switch(op)
  {
